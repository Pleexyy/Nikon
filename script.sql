...
INSERT INTO Produits
        (id, nom, presentation, prix, image, description, stock)
VALUES
            ...
            Le système est configurable en 153, 72 ou 25 points en mode AF continu.", 50),
            ...
            qualité supérieure garantit une netteté parfaite sur tout le champ et une distorsion minimale.", 50),
            ...
            une fonction pratique si vous utilisez un filtre.", 50),
            ...
            Plongez dans les plus petits détails de la vie.", 50),
            ...
            Disponible en diamètres 52/58/62/67/72/77 mm.", 50),
            ...
            Disponible en diamètres 52/62/67/72/77 mm.", 50),
            ...
            Disponible en diamètres 52/58/62/72/77 mm.", 50),
            ...
            la section « Produits associés » ci-dessous.", 50),
            ...
            mission de capter l'intensité du moment en une fraction de seconde.", 50),
            (12, "Parasoleil HB-64", "Parasoleil à baïonnette, qui réduit la lumière parasite (flare)", 38.90, "images/parasoleil.png", "Parasoleil à baïonnette, qui réduit la lumière parasite (flare).", 50);
