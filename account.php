...
<body>
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Accueil</a> <span class="mx-2 mb-0">/</span> <strong
              class="text-black">Mon compte</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-7">
            <form action="inscription.php" method="post" onsubmit="inscription()">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_password2" class="text-black">Confirmation du mot de passe <span
                ...
                <div class="col-md-7">
                  ...
                  <form action="connexion.php" method="post">
                    ...
                    <div class="p-3 p-lg-5 border">
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                          <label for="c_password" class="text-black">Mot de passe <span
                              class="text-danger">*</span></label>
                          <input type="password" class="form-control" id="c_password" name="c_password">
                        </div>
                      </div>
